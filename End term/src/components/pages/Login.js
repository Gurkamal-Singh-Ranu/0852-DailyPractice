...
return(
    <div style={{margin:"8% 30% 0% 30%"}}>
        <h2 style={{margin:"0% 0% 5% 40%",color : "white"}}>Login</h2>
    <form>
  ...
  <div className="row mb-4">
    <div className="col d-flex justify-content-center">
      ...
      <div className="form-check">
        ...
        <label className="form-check-label" for="form2Example34" style={{color:"white",fontWeight : "bold"}}> Remember me </label>
      </div>
    </div>
  ...
  <div className="text-center">
    <p style={{color : "white",fontWeight : "bold"}}>Not a member? <Link to="/signup">Register</Link></p>
  </div>
</form>
    </div>
